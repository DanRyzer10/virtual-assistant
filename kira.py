...
import wikipedia, os, pywhatkit
import chistesESP as chistes
import random

# Nombre del asistente
name='kira'# TODO: Debes ingresar el nombre de tu asistente aqui
...
engine.setProperty('voice', voice_engine[2].id)
...
# Metodo que permite al asistente hablar
def talk(text):
    engine.say(text)
    engine.runAndWait()
...
def write(f):
    ...
    recognizer_write = listen()
    f.write(recognizer_write + os.linesep)
    f.close
